...
noteController.get(
    ...
    async ({ params, query, user }: Request, res: Response): Promise<void> => {
        try {
...
noteController.post(
    '/sessions/:sessionId/notes',
    async ({ params, body, user }: Request, res: Response): Promise<void> => {
        try {
...
noteController.get(
    '/notes/:noteId',
    async ({ params, user }: Request, res: Response): Promise<void> => {
        try {
